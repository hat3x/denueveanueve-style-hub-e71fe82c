...
const whatsappOptions = [
  {
    label: "Collado Villalba / Alpedrete",
    number: "34606076044",
  },
  {
...
const MESSAGE = "Hola, me gustaría reservar una cita en Denueveanueve. 💇‍♀️";
...
const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-50">
      {open && (
        <div className="mb-3 bg-background border border-border rounded-xl shadow-xl p-4 w-64 animate-in fade-in slide-in-from-bottom-2">
          <div className="flex items-center justify-between mb-3">
            <span className="font-body text-sm font-semibold text-foreground">¿A qué centro contactas?</span>
